...
I used a chi2 to consider if survival was independent of sex. Our null
hypothesis is that survival does not differ based on sex. the
alternative is that it does. I found a chi21=147.76, which corresponds
to a p-value of \<.001, so i reject the null hypothesis.
...
hypotheses remain the same. I attempted to use a chi2 test but was
...
Fisher's Test.I found a p-value of 1, thus I fail to reject the null
hypothesis.
...
differs aross time periods) using chi2 test. However, a warning and
...
A p-value of .4138 which is greater than 0.05 means that I have failed

...
The p-value is not equal to .5 so therefore we reject the null
hypothesis. The 95% 5% CI is .562 - .888.
...
hypothesis that the proportion of correct answers is .25, which would be
if it was all by chance, 1/4, or 25%.

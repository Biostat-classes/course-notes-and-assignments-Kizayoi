...
ggplot(sleep, aes(x=TotalSleep, y = BrainWt)) +
  geom_point()+
  xlab("Total sleep (hours per day")+ggtitle("BrainWt Decreases With TotalSleep")+
...
There is a slight decrease of Total Sleep for every increase in
Predation.
...
really mean. The larger the sample, the more credible, and less room for
data mishaps. There are also more distributions that can be seen with a
larger sample size compared to a smaller one.
